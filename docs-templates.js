...
(function(){
  ...
  function contract(ctx){
    ...
    var h = '<div class="page">' +
      ...
      '<tr><th rowspan="3">근로자</th><th>성명</th><td>' + v(s.name) + '</td><th>주민등록번호</th><td>' + (s.residentNumber ? esc(s.residentNumber) : c.residentBlank ? v('', 90) : '<span class="small muted">별도 서면 제출</span>') + '</td></tr>' +
